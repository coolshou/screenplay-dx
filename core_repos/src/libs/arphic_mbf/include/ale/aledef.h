/*
       ...
       Arphic Layout Engine    ver $Name: le_v02170300_20090402 $
           Copyright (C) 2001-2007 Arphic Technology Co., Ltd. All rights reserved.
...
/*----------------------------------- Working Buffer   ------------------------------------------ */
         ...
         struct AleWorkInfoType
           ...
           #define PAleGetFontWidthBBox  (*WInfo-> FD. AleGetFontWidthBBox)
           #define PAleGetFontHeightBBox (*WInfo-> FD. AleGetFontHeightBBox)
...
/*-------------------------- language-specific subfunctions ------------------------------------------ */
 ...
 #endif  /* sub functions for some languages */
