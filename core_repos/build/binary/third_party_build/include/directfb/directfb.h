...
/*
 * Constant for testing the existence and level of <b>Sigma extensions</b>
 */
#define DIRECTFB_SIGMA_EXTENSIONS  0x101
...
typedef enum {
     ...
     DDM_ADAPTIVE               = 0x00000002,     /* weave with best motion adaptive fallback to bob */
     ...
     DDM_ADAPTIVE_TWO_FIELDS    = 0x00000010,     /* same as Adaptive, but with only 2 reference fields */
} DFBDeinterlacingMode;

/*
 * Stereoscopic image formats. <b>Sigma extension</b>
 */
typedef enum {
     DSSF_NONE              	= 0x00000000,         /* no stereoscopic support */
     DSSF_SIDE_BY_SIDE_HALF 	= 0x00000001,         /* side-by-side half frame stereoscopic format */
     DSSF_TOP_AND_BOTTOM_HALF   = 0x00000002,         /* top and bottom half frame stereoscopic format */
} DFBStereoscopicFormat;
...
typedef enum {
     ...
     DLCAPS_STEREO_FORMATS    = 0x01000000,  /* Stereoscopic input formats are supported. <b>Sigma extension</b> */
     DLCAPS_STEREO_SOURCE     = 0x02000000,  /* Stereoscopic sources are supported. <b>Sigma extension</b> */
     DLCAPS_STEREO_UPMIX      = 0x04000000,  /* Monoscopic to stereoscopic upmix is supported. <b>Sigma extension</b> */

     DLCAPS_ALL               = 0x07F3FFFF
...
typedef enum {
     ...
     DSDESC_PREALLOCATED_DRAM = 0x00000040,  /* Surface uses data that has been
                                             preallocated by the application using
                                             RUAMalloc.
                                             The field array 'preallocated'
                                             has to be set using the first
                                             element for the front buffer
                                             and eventually the second one
                                             for the back buffer. Each element
                                             contains a u32 DRAM address (as
                                             allocated by RUA) pointing to the
                                             beginning of the pixel data; the
                                             'data' member is the mapped address
                                             of the DRAM area.
                                             <b>Sigma extension</b> */
     DSDESC_ALL               = 0x0000007F   /* all of these */
...
typedef enum {
     ...
     DSCAPS_PAGE_ALIGNED  = 0x00100000   /* The surface buffers are page aligned; needed for OpenGL surfaces <b>Sigma extension</b> */
...
typedef enum {
     ...
     DFXL_GEOMETRIC_XFORM = 0x00100000,  /* GeometricXform() is accelerated. */

     DFXL_DRAWSTRING      = 0x01000000,  /* DrawString() and DrawGlyph() are accelerated. */

     DFXL_ALL             = 0x0137000F   /* All drawing/blitting functions. */
} DFBAccelerationMask;
...
typedef enum {
     ...
     DBDESC_STREAMING    = 0x00000004   /* Create a fixed size buffer without
...
/*
 * <b>Sigma extensions:</b> Font style definitions.
 */
typedef enum {
     DFFSTYLE_Default    = 0, /* default or unspecified style */
     DFFSTYLE_Bold,                /* <b>Bold</b> font style */
     DFFSTYLE_Italic,              /* <i>Italic</i> font style */
     DFFSTYLE_BoldItalic           /* <b><i>BoldItalic</i></b> font style */
} DFBFontStyle;
...
typedef enum {
     ...
     DFDESC_NAME          = 0x00000080,  /* <b>Sigma extensions:</b> font's name is specified */
     DFDESC_STYLE         = 0x00000100,  /* <b>Sigma extensions:</b> font's style is specified */
 ...
 *
 * <b>Sigma extensions:</b> A particular face name and/or size may be specified. If they are specified
 * but not found in the font file, the IDirectFB::CreateFont() call will fail.
 */
typedef struct {
     ...
     char                                    name[128];     /* <b>Sigma extensions:</b> font's name */
     DFBFontStyle                            style;         /* <b>Sigma extensions:</b> font's style */
} DFBFontDescription;
...
typedef enum {
	...
	/* HACK!!! Support for AVYU exists in DF 1.4.3; we hacked the AYUV format to behave like AVYU,
     * which is what the hardware actually supports. */
...
typedef struct {
     ...
     struct {
          ...
          u32                           dram;        /* DRAM address for PREALLOCATED_DRAM mode <b>Sigma extension</b> */
     } preallocated[2];
...
typedef struct {
     ...
     DFBStereoscopicFormat                   stereoscopic_formats; /* stereoscopic input formats supported by DLCAPS_STEREOSCOPIC_FORMATS capable layers <b>Sigma extension</b> */
...
typedef enum {
     ...
     DCAF_SATURATION_CB = 0x00000020,  /* cb_saturation field is valid <b>Sigma extension</b> */
     DCAF_SATURATION_CR = 0x00000040,  /* cr_saturation field is valid <b>Sigma extension</b> */
     DCAF_ALL           = 0x7F
...
typedef struct {
     ...
     u16                    cb_saturation;   /* Cb saturation <b>Sigma extension</b> */
     u16                    cr_saturation;   /* Cr saturation <b>Sigma extension</b> */
} DFBColorAdjustment;
...
DEFINE_INTERFACE(   IDirectFB,
   ...
   /** Media **/
      ...
      * of how to load the glyphs. <b>Sigma extended</b>
      *
      * Sigma extensions:<br>
      * - <i><b>filename</b></i> can specify a buffer in memory: <b>&#64</b>&#60address&#62:&#60size&#62<br>
      */
...
typedef enum {
     ...
     DLCONF_STEREO_FORMAT          = 0x00000400,      /* Layer is displaying 3D data of the stereoscopic format specified in the stereo_format field <b>Sigma extension </b> */
     DLCONF_STEREO_UPMIX_OFFSET    = 0x00001000,      /* Layer is displaying 2D data, use the stereo_upmix_offset value to convert it to the output 3D format. Default: 0 <b>Sigma extension </b> */

     DLCONF_ALL                    = 0x00001FFF
...
typedef struct {
     ...
     DFBStereoscopicFormat         stereo_format;           /* stereoscopic input format <b>Sigma extension</b> */
     int                           stereo_upmix_offset;     /* offset for upmixing monoscopic data into stereoscopic images <b>Sigma extension</b> */
...
typedef enum {
     ...
     DSOCAPS_STEREOSCOPIC_FORMATS = 0x00000100, /* Stereoscopic output formats are supported. <b>Sigma extension</b> */
...
//     DSOS_656            = 0x00000040, /* 656 Digital output signal */
    ...
    /** Sigma extensions, replace the definitions above, as they are really connectors, not signals **/
    ...
    DSOS_NTSC           = 0x00000001, /* NTSC <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */
    DSOS_NTSC_J         = 0x00000002, /* NTSC Japan <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */

    DSOS_SECAM          = 0x00000004, /* SECAM <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */

    DSOS_PAL            = 0x00000008, /* PAL BG <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */
    DSOS_PAL_M          = 0x00000010, /* PAL M <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */
    DSOS_PAL_60         = 0x00000020, /* PAL 60 <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */

    DSOS_SDTV           = 0x00000040, /* SDTV 480I/576I signal <b>Sigma extension</b> */
    DSOS_EDTV           = 0x00000080, /* EDTV 480P/576P signal <b>Sigma extension</b> */
    DSOS_640x480        = 0x00000100, /* VESA/CVT 640x480 signal <b>Sigma extension</b> */
    DSOS_800x600        = 0x00000200, /* VESA/CVT 800x600 signal <b>Sigma extension</b> */
    DSOS_1024x768       = 0x00000400, /* VESA/CVT 1024x768 signal <b>Sigma extension</b> */
    DSOS_1152x864       = 0x00000800, /* VESA/CVT 1152x864 signal <b>Sigma extension</b> */
    DSOS_720p           = 0x00001000, /* HDTV/VESA 720P (1280x720) signal <b>Sigma extension</b> */
    DSOS_1280x768       = 0x00002000, /* VESA 1280x768 signal <b>Sigma extension</b> */
    DSOS_1280x960       = 0x00004000, /* VESA/CVT 1280x960 signal <b>Sigma extension</b> */
    DSOS_1280x1024      = 0x00008000, /* VESA/CVT 1280x1024 signal <b>Sigma extension</b> */
    DSOS_1360x768       = 0x00010000, /* VESA 1366x768 signal <b>Sigma extension</b> */
    DSOS_1366x768       = 0x00020000, /* VESA 1366x768 signal <b>Sigma extension</b> */
    DSOS_1400x1050      = 0x00040000, /* VESA 1400x1050 signal <b>Sigma extension</b> */
    DSOS_1440x900        = 0x00080000, /* VESA 1440x900 signal <b>Sigma extension</b> */
    DSOS_1600x1200      = 0x00100000, /* VESA/CVT 1600x1200 signal <b>Sigma extension</b> */
    DSOS_1680x1050      = 0x00200000, /* VESA 1680x1050 signal <b>Sigma extension</b> */
    DSOS_1792x1344      = 0x00400000, /* VESA 1792x1344 signal <b>Sigma extension</b> */
    DSOS_1856x1392      = 0x00800000, /* VESA 1856x1392 signal <b>Sigma extension</b> */
    DSOS_1080i          = 0x01000000, /* HDTV/VESA 1080I (1920x1080) signal <b>Sigma extension</b> */
    DSOS_1080p24         = 0x02000000, /* HDTV 1080P24 (1920x1080) (cinema source direct) signal <b>Sigma extension</b> */
    DSOS_1080p          = 0x04000000, /* HDTV 1080P (1920x1080) signal <b>Sigma extension</b> */
    DSOS_1920x1200      = 0x08000000, /* VESA 1920x1200 signal <b>Sigma extension</b> */
    DSOS_1920x1440      = 0x10000000, /* VESA 1920x1440 signal <b>Sigma extension</b> */

    DSOS_EDID           = 0x20000000, /* signal selected by HDMI EDID <b>Sigma extension</b> */
...
typedef struct {
     ...
     DFBStereoscopicFormat		 stereoscopic_formats; /* stereoscopic formats supported by DSOCAPS_STEREOSCOPIC_FORMATS capable outputs <b>Sigma extension</b> */
     DFBStereoscopicFormat		 preferred_stereoscopic_formats; /* stereoscopic formats preferred by DSOCAPS_STEREOSCOPIC_FORMATS capable outputs <b>Sigma extension</b> */
...
typedef enum {
     ...
     DSECAPS_STEREO_FORMATS     = 0x00020000, /* Stereoscopic output formats are supported. <b>Sigma extension</b> */

     DSECAPS_ALL          = 0x0003ff1f
...
typedef struct {
     ...
     DFBStereoscopicFormat         stereo_formats;     /* Stereoscopic output formats supported by DSECAPS_STEREOSCOPIC_FORMATS capable encoders <b>Sigma extension</b> */
...
typedef enum {
     ...
     DSECONF_STEREO_FORMAT  		= 0x01000000, /* Set the stereoscopic format specified in the stereoscopic_format field. <b>Sigma extension</b> */
     DSECONF_STEREO_AUTO_FORMAT  	= 0x02000000, /* Set the stereoscopic format selected automatically based on content format and output capabilities. <b>Sigma extension</b> */

     DSECONF_ALL                    = 0xE30003FF
...
//   DFBAspectRatio                display_aspect;     /* Display aspect ratio <b>Sigma extension</b> */
     ...
     u8                            delayed_config;     /* If true, don't apply settings right away. <b>Sigma extension</b>*/

     DFBStereoscopicFormat         stereo_format;      /* Stereoscopic output format used by DSECONF_STEREOSCOPIC_FORMAT-configured encoders. <b>Sigma extension</b> */
     DFBBoolean                    stereo_auto_format; /* Stereoscopic output format is decided automatically when the sink supports 3d. <b>Sigma extension</b> */
...
/*
 * Geometric transformations of a surface. <b>Sigma extension</b>
 *
 */
typedef enum {
     DSGT_NONE                = 0x00000000,

    DSGT_ROTATION_90,                             /* rotation by 90 degrees, mutually exclusive with any other rotation */
     DSGT_ROTATION_180,                           /* rotation by 180 degrees, mutually exclusive with any other rotation */
     DSGT_ROTATION_270,                           /* rotation by 270 degrees, mutually exclusive with any other rotation */
     DSGT_ROTATION_TEST = DSGT_ROTATION_90 | DSGT_ROTATION_180 | DSGT_ROTATION_270, /* rotation type extraction mask */

    DSGT_MIRROR_HORIZONTAL   = 0x00000004,  /* horizontal flip */
    DSGT_MIRROR_VERTICAL     = 0x00000008,  /* vertical flip */
} DFBSurfaceGeometricTransform;
...
DEFINE_INTERFACE(   IDirectFBSurface,
   ...
   /** Blitting control **/
     ...
     DFBResult (*SetIndexTranslation) (
      ...
      /*
       * Transform a surface according to a set of transformation flags. <b>Sigma extension</b>
       *
       * The resulting surface is returned in out_surface.
       */
      DFBResult (*GeometricTransform) (
            IDirectFBSurface              *thiz,
            DFBSurfaceGeometricTransform   xform,
...
DEFINE_INTERFACE(   IDirectFBFont,
   ...
   /** Retrieving information **/
      ...
      *
      * No character extends further above the baseline
      * than this height.
      */
     DFBResult (*GetMaxAscent) (
          IDirectFBFont       *thiz,
          int                 *ret_maxascent
     );
      ...
      *
      * No character extends further below the baseline
      * than this height.
      */
     DFBResult (*GetMaxDescent) (
          IDirectFBFont       *thiz,
          int                 *ret_maxdescent
     );
...
DEFINE_INTERFACE(   IDirectFBDataBuffer,
   ...
   /** Miscellaneous **/
     ...
     /*
      * Get the type of data buffer: streaming, memory of file.
      */
     DFBResult (*GetType) (
          IDirectFBDataBuffer           *thiz,
          DFBDataBufferDescriptionFlags *type
     );
)
