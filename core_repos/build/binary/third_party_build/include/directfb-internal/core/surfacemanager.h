...
typedef DFBResult (*dfb_preallocate_setup)(SurfaceBuffer *buffer);
typedef DFBResult (*dfb_preallocate_cleanup)(SurfaceBuffer *buffer);

void dfb_surfacemanager_set_alloc_funcs(SurfaceManager *manager,
    dfb_custom_allocate alloc,
    dfb_custom_deallocate dealloc);

void dfb_surfacemanager_set_prealloc_funcs(SurfaceManager *manager,
    dfb_preallocate_setup setup,
    dfb_preallocate_cleanup cleanup);
...
/*
 * Try to lock the surfacemanager; return 0 if successfully locked.
 */
DFBResult dfb_surfacemanager_trylock( SurfaceManager *manager );
