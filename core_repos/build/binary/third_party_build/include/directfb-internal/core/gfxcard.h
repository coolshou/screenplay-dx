...
typedef struct _GraphicsDeviceFuncs {
	  ...
	  */
	 bool (*GeometricXform)  ( void *driver_data, void *device_data,
							   DFBSurfaceGeometricTransform xform,
							   IDirectFBSurface **out_surf );
} GraphicsDeviceFuncs;
...
DFBResult dfb_gfxcard_geometric_xform( DFBSurfaceGeometricTransform xform, 
									   IDirectFBSurface **out_surf, 
									   CardState *state );
