...
extern "C"
 {
   ...
   /* Initialization
      -------------------------------- */
   ALE_INT16 RbmpReset (char *AWorkBuf ,ALE_UINT16 bufSize, RBMP_FONTDATA *RbmpGetDataProcInstance,
                          void (*ARbmpGetDataProc)   (RBMP_FONTDATA *RbmpInstance, ALE_UINT32 rbmOffs,
   ...
   ALE_INT32  RbmpSetFontWithAttr (struct FONTTYPEFACE ftf, ALE_INT16 *AResultAttr,
                                     ALE_INT16 *APostProcessAttr, char *WorkBuf   );
   ...
   ALE_INT16 RbmpGetFFormat (ALE_INT16 fidx, ALE_UINT16 *FullFontFormat,
    ...
    /* Char Info Cache
       ------------------------ */
    ALE_INT32 RbmpSetCharInfoCache (RBMPCharInfoCache *cache, char *WorkBuf);
