...
#define LeVersion "$Name: le_v02170300_20090402 $"
       ...
       /* For convenience, if "All language" not defined, and any
          ...
          ------------------------------------------------------------------------ */
            ...
            #define __ARPHIC_LAYOUTENGINE_PARTIALLANGUAGE__
              ...
              #define __ARPHIC_LAYOUTENGINE_PARTIALLANGUAGE__
              #else
                #if (defined (__ARPHIC_LAYOUTENGINE_TELUGU__) ||  defined (__ARPHIC_LAYOUTENGINE_KANNADA__) ||  defined (__ARPHIC_LAYOUTENGINE_ORIYA__) )
                #define __ARPHIC_LAYOUTENGINE_PARTIALLANGUAGE__
                #endif
              #endif
            #endif
