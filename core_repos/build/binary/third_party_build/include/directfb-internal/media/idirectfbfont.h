...
/*
 * set the pixel aspect ratio of the screen
 */
void IDirectFBFont_SetScreenPixelAspect(double ar_x, double ar_y);

/*
 * get the pixel aspect ratio of the screen
 */
void IDirectFBFont_GetScreenPixelAspect(double *ar_x, double* ar_y);
