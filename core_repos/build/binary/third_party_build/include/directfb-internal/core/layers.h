...
struct __DFB_CoreLayerRegionConfig {
     ...
     DFBStereoscopicFormat stereo_format;           // <b>Sigma extension</b>
     DFBStereoscopicFormat stereo_upmix_offset;     // <b>Sigma extension</b>
};
...
typedef enum {
     ...
     CLRCF_FLICKER_FILTER     = 0x00400000,	 // <b>Sigma extension</b>
     CLRCF_DEINTERLACING_MODE = 0x00800000,	 // <b>Sigma extension</b>
     CLRCF_ASPECT_MATCHING    = 0x01000000,	 // <b>Sigma extension</b>
     CLRCF_STEREO_FORMAT      = 0x02000000,	 // <b>Sigma extension</b>
     CLRCF_STEREO_UPMIX_OFFSET= 0x04000000,	 // <b>Sigma extension</b>

     CLRCF_SURFACE            = 0x10000000,
     CLRCF_PALETTE            = 0x20000000,

     CLRCF_ALL                = 0x37D3337F
