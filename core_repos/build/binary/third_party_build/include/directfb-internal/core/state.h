...
typedef enum {
     ...
     SMF_SRC_BLEND_ORIG    = 0x00010000,
     SMF_DST_BLEND_ORIG    = 0x00020000,
...
struct _CardState {
     ...
     DFBSurfaceBlendFunction  src_blend_orig;/* original blend function for source (for fonts, who only use SRCALPHA/INVSRCALPHA) (Sigma extension) */
     DFBSurfaceBlendFunction  dst_blend_orig;/* original blend function for destination (for fonts, who only use SRCALPHA/INVSRCALPHA) (Sigma extension) */
...
#define dfb_state_set_src_blend_orig(state,blend) _dfb_state_set_checked( src_blend_orig, \
                                                                          SRC_BLEND_ORIG, \
                                                                          state, blend )

#define dfb_state_set_dst_blend_orig(state,blend) _dfb_state_set_checked( dst_blend_orig, \
                                                                          DST_BLEND_ORIG, \
                                                                          state, blend )
