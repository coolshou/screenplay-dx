...
#endif
#if BI_KANJI_HINTING
    BI_INT32                NoConnectLine;
                            /* Non-zero values enable no-connect-line correction. 0 disables it */
#endif
} BI_Raster_Params;

#if BI_KANJI_HINTING
enum /* Or flags for BI_Raster_Params::NoConnectLine */
{
    NO_CONNECT_LINE_RIGHT   =1<<0,
    NO_CONNECT_LINE_DOWN    =1<<1
};
#endif
